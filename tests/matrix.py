...
# Scratch root.  Overridable because two agents sharing one machine
# otherwise delete each other's fixtures mid-run: `gen` rewrites the
# whole directory, and the other suite's reader then finds nothing.
DIR = os.environ.get("PQ_TMP", "/tmp/pq_deep")
